...
public class VerifyAllProductsPriceAndStock extends BaseTest {
    @Test
    public void verifyAllProductsPriceAndStock() throws IOException {
        //---Login
        ...
        //--Show All Products their price and Stock--//
        sale.showAllProducts();
        sale.getProductPrice();
        System.out.println("Product Price is " + sale.getProductPrice());
        sale.getProductStock();
        System.out.println("Product Stock is " + sale.getProductStock());
