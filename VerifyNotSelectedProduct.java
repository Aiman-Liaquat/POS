...
public class VerifyNotSelectedProduct extends BaseTest {
    @Test
    public void VerifyNotSelectedProduct(){
        //---Login
        ...
        sale.productNotSelected();
        System.out.println("Alert: " + sale.productNotSelected());
