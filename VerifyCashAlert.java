...
public class VerifyCashAlert extends BaseTest {
    @Test
    public void VerifyCashAlert(){
        //---Login
        ...
        sale.enterCustPhone("+92123456788");
        sale.getCustPhone();
        ...
        sale.okPriceAlerts();
        sale.showCashAlert();
        System.out.println("Alert: " +sale.showCashAlert());
